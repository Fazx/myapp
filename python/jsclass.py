...
class JiangSu():
    ...
    def login(self,cardtype,username,password,code):
        ...
        data={
            'jsonData':'{"handleCode":"loginByJsswZjhm","data":{"appId":"201706281026","zjLxDm":"'+self.cardtypes[cardtype]+'","zjHm":"'+username+'","yhmm":"'+password+'","yzm":"'+code+'"}}'
        }
        res=self.session.post("http://www.jsds.gov.cn/LoginAction.do",data=data,headers=self.headers,verify=False)
...
if __name__=="__main__":
    ...
    js.login(cardtype,username,password,code)
