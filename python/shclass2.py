...
class ShangHai():
    ...
    def yzm(self,token):
        ...
        with open("/home/wwwroot/wbsr/python/images/"+self.pname+".jpg",'wb')as f:
            f.write(res.content)


    def pretreat_image(self,image):
        image = ImageOps.invert(image)
        image.save("/home/wwwroot/wbsr/python/images/"+self.pname+".jpg")
        image = Image.open("/home/wwwroot/wbsr/python/images/"+self.pname+".jpg")
...
# 灰度图像二值化,返回0/255二值图像
    ...
    def tokenlogin(self,idtype,idnum,password,code):
        
        with open("/home/wwwroot/wbsr/python/images/"+self.pname+".txt","r") as f:
            public_key=f.read()
            f.close()
        headerss={
...
if __name__=="__main__":
    ...
    try:
        ...
        token=sh.login()
        #sh.yzm(token)
        with open("/home/wwwroot/wbsr/python/images/"+sh.pname+'.txt','w') as f:
        ...
        while True:
            sh.yzm(token)
            #print(sh.pname)
            code=sh.readcode("/home/wwwroot/wbsr/python/images/"+sh.pname+".jpg")
        ...
        result=sh.tokenlogin(idtype,idnum,password,code)
        if result == "100":
            print(100)
            ...
            sh.detail()
            os.remove("/home/wwwroot/wbsr/python/images/"+sh.pname+".jpg")
            os.remove("/home/wwwroot/wbsr/python/images/"+sh.pname+".txt")
