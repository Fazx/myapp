...
class NeiMengGu():
    ...
    def login(self,cardtype,name,mm,code):
        ...
        data={"yhm":"","idType":self.cardtypes[cardtype],"idNumber":name,"mm":mm,"authCode":code,"redirect_uri":"","response_type":"","client_id":"","sign":"","st":"","dllx":"yhm"}
...
if __name__=="__main__":
    ...
    while True:
        ...
        uname=nmg.login(cardtype,name,mm,code)
        if uname:
