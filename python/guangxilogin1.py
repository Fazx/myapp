...
class GuangXi():
    ...
    def getmm(self,password,rsapubkey):
        ...
        return cipher_text
    def login(self,cardtype,username,mm,code):
        headers = {
            "User-Agent": "Mozilla/5.0 (Windows NT 6.3; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/63.0.3239.132 Safari/537.36",
            "Accept": "application/json, text/javascript, */*; q=0.01",
            "Content-Type": "application/json;charset=UTF-8"
        }
        data={"yhm":"","idType":self.cardtypes[cardtype],"idNumber":username,"mm":mm,"authCode":code,"redirect_uri":"","response_type":"","client_id":"","sign":"","st":"","dllx":"yhm","state":""}
...
if __name__=="__main__":
    # sys.argv = ["0111111", "身份证","452323196903191025", "a123456789"]
    ...
    try:
        ...
        uname=gx.login(cardtype,username,mm,code)
        if uname=="100":
            print(100)
        elif uname=="300":
            print(300)
