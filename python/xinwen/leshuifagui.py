...
import logging
logging.basicConfig(level = logging.INFO,format = '%(asctime)s - %(name)s - %(levelname)s - %(message)s',filename="/home/wwwlogs/python/leshuilog.txt")
...
class LeShui():
    ...
    cityid={'中央': pymysql.escape_string('[\"2\",\"7\",\"16\",\"141\"]'), '北京市': pymysql.escape_string('[\"2\",\"7\",\"16\",\"142\"]'), '上海市': pymysql.escape_string('[\"2\",\"7\",\"16\",\"143\"]'), '天津市': pymysql.escape_string('[\"2\",\"7\",\"16\",\"144\"]'), '河北省': pymysql.escape_string('[\"2\",\"7\",\"16\",\"145\"]'), '山西省': pymysql.escape_string('[\"2\",\"7\",\"16\",\"146\"]'), '内蒙古自治区': pymysql.escape_string('[\"2\",\"7\",\"16\",\"147"]'), '辽宁省': pymysql.escape_string('[\"2\",\"7\",\"16\",\"148\"]'), '吉林省': pymysql.escape_string('[\"2\",\"7\",\"16\",\"149\"]'), '黑龙江省': pymysql.escape_string('[\"2\",\"7\",\"16\",\"151\"]'), '江苏省': pymysql.escape_string('[\"2\",\"7\",\"16\",\"190\"]'), '浙江省': pymysql.escape_string('[\"2\",\"7\",\"16\",\"195\"]'), '安徽省': pymysql.escape_string('[\"2\",\"7\",\"16\",\"196\"]'), '福建省': pymysql.escape_string('[\"2\",\"7\",\"16\",\"200\"]'), '江西省': pymysql.escape_string('[\"2\",\"7\",\"16\",\"201\"]'), '山东省': pymysql.escape_string('[\"2\",\"7\",\"16\",\"202\"]'), '河南省': pymysql.escape_string('[\"2\",\"7\",\"16\",\"204\"]'), '湖北省': pymysql.escape_string('[\"2\",\"7\",\"16\",\"205\"]'), '湖南省': pymysql.escape_string('[\"2\",\"7\",\"16\",\"206\"]'), '广东省': pymysql.escape_string('[\"2\",\"7\",\"16\",\"208\"]'), '广西壮族自治区': pymysql.escape_string('[\"2\",\"7\",\"16\",\"210\"]'), '海南省': pymysql.escape_string('[\"2\",\"7\",\"16\",\"213\"]'), '重庆市': pymysql.escape_string('[\"2\",\"7\",\"16\",\"214\"]'), '四川省': pymysql.escape_string('[\"2\",\"7\",\"16\",\"215\"]'), '贵州省': pymysql.escape_string('[\"2\",\"7\",\"16\",\"216\"]'), '云南省': pymysql.escape_string('[\"2\",\"7\",\"16\",\"218\"]'), '西藏自治区': pymysql.escape_string('[\"2\",\"7\",\"16\",\"220\"]'), '陕西省': pymysql.escape_string('[\"2\",\"7\",\"16\",\"221\"]'), '甘肃省': pymysql.escape_string('[\"2\",\"7\",\"16\",\"223\"]'), '青海省': pymysql.escape_string('[\"2\",\"7\",\"16\",\"225\"]'), '宁夏回族自治区': pymysql.escape_string('[\"2\",\"7\",\"16\",\"227\"]'), '新疆维吾尔自治区': pymysql.escape_string('[\"2\",\"7\",\"16\",\"229\"]')}
    def __init__(self):
    ...
    def getindexs(self,res):
        for index,i in enumerate(res["areaNodes"]):
            if "open" in i:
                return index

    def getpage(self,res,index):
        allcity=res["areaNodes"][index+1:-1]
        allcity.append(res["areaNodes"][0])
        for j in allcity:
            item = {}
            city=j["name"]
            ...
            # item["city"]=city
            # item["area"]=area
            res=self.session.get("https://www.leshui365.com/law/a"+id+"-v0/?s10-new.html",headers=self.header,verify=False)
            ...
            for url in urls:
                ...
                try:
                    ...
                    detail_item["type_list"]=self.cityid[city]
                    detail_item["type_name"]="法规库,全部法规,地域范围,"+city
                    #print(detail_item)
                    Db = Dbmysql()
    ...
    def detail(self,res):
        try:
            ...
            item["column_list_id"] = pymysql.escape_string('[\"98\"]')
            item["need_login"] = 0
            item["date"] = date
            item["uid"] = uid
    ...
    try:
        ...
        while True:
            ...
            if result == True:
                ...
                ls.login(code)
                res = ls.indexs()
                index = ls.getindexs(res)
                lists = ls.getpage(res, index)
                break
            time.sleep(1)
            if num == 100:
                break
